                ...
                <form method="post" action="{{route('owner.products.update',['product' => $product->id])}}">
                    ...
                    <div class="-m-2">
                      <div class="p-2 w-1/2 mx-auto">
                        <div class="relative">
                            <label for="name" class="leading-7 text-sm text-gray-600">表品名 ※必須</label>
                  ...
                  <div class="p-2 w-1/2 mx-auto">
                      <div class="relative">
                          ...
                          <input type="number" id="sort_order" name="sort_order" rows="10" required class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" value="{{$product->sort_order}}"></input>
                      </div>
                  </div>
                  <div class="p-2 w-1/2 mx-auto">
                    <div class="relative">
                        <label for="current_quantity" class="leading-7 text-sm text-gray-600">現在のç在庫 ※必須</label>
                        <input class="text-base outline-none text-gray-700 py-1 px-3 leading-8" type="hidden" id="current_quantity" name="current_quantity" rows="10" required required value="{{$quantity}}"></input>
